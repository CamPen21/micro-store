...
func (x *OrderPlacementResponse) Reset() {
	*x = OrderPlacementResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *OrderPlacementResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderPlacementResponse) ProtoMessage() {}

func (x *OrderPlacementResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_order_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderPlacementResponse.ProtoReflect.Descriptor instead.
func (*OrderPlacementResponse) Descriptor() ([]byte, []int) {
	return file_proto_order_proto_rawDescGZIP(), []int{3}
}

func (x *OrderPlacementResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *OrderPlacementResponse) GetOrderId() int32 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
var file_proto_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x3f, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d,
	...
	0x74, 0x69, 0x74, 0x79, 0x22, 0x40, 0x0a, 0x11, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x0b, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x0a, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x2f, 0x0a, 0x12, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x16, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x50, 0x6c, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x32, 0x94, 0x01, 0x0a, 0x16, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x6c, 0x61, 0x63, 0x65,
	...
	0x73, 0x74, 0x1a, 0x17, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x6d,
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x24, 0x5a,
	0x22, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2d, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x2d, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x70, 0x72,
...
var file_proto_order_proto_goTypes = []interface{}{
	...
	(*PlaceOrderRequest)(nil),      // 1: PlaceOrderRequest
	(*CancelOrderRequest)(nil),     // 2: CancelOrderRequest
	(*OrderPlacementResponse)(nil), // 3: OrderPlacementResponse
}
var file_proto_order_proto_depIdxs = []int32{
	0, // 0: PlaceOrderRequest.order_items:type_name -> OrderItem
	1, // 1: OrderManagementService.PlaceOrder:input_type -> PlaceOrderRequest
	2, // 2: OrderManagementService.CancelOrder:input_type -> CancelOrderRequest
	3, // 3: OrderManagementService.PlaceOrder:output_type -> OrderPlacementResponse
	3, // 4: OrderManagementService.CancelOrder:output_type -> OrderPlacementResponse
...
func file_proto_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_order_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OrderPlacementResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
